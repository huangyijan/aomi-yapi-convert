...
const targetJson = {
  ...
  outputStyle: 'default', // 支持值defaultExport(example: export default {xxx}), nameExport（example: export function name() {xxx}）, anonymous(example: export const variable = function() {xxx}),分别对应了默认导出，具名导出，匿名函数导出
